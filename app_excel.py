...
with col_logo:
    try:
        logo = Image.open("2 Logo PIJ de 400 x 150 px_Mesa de trabajo 1.png")
        st.image(logo, width=500)  # Ajustamos el ancho para que se vea bien
    except Exception as e:
        st.error("No se pudo cargar el logo. Verifica que el archivo esté en el directorio correcto.")
